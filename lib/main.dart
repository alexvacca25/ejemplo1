-
import 'package:ejemplo1/componentes/alinear.dart';
import 'package:ejemplo1/componentes/alinear1.dart';
import 'package:ejemplo1/componentes/centrado.dart';
import 'package:ejemplo1/componentes/contador.dart';
import 'package:ejemplo1/componentes/contador1.dart';
import 'package:ejemplo1/componentes/expandir.dart';
import 'package:ejemplo1/componentes/imagenes.dart';
import 'package:ejemplo1/componentes/materialapp.dart';
import 'package:ejemplo1/componentes/modelo.dart';
import 'package:ejemplo1/componentes/perfilusuario.dart';
import 'package:ejemplo1/componentes/textos.dart';

import 'package:ejemplo1/componentes/walinear.dart';
          ...
          body: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Menu(texto: 'Ejemplos Nuevos', ruta: (context) => Perfil()),
                SizedBox(height: 10),
                Menu(
